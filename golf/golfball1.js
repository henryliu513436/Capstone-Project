var toggle=false;
let x=0; //測試用
var stopId=undefined; //紀錄返回值


function draw(initisped,elevang,direcang){  //相當eventlisener
    ...
    function animate() {
        ...
        let ball = scene.getObjectByName("my-golf");
        ...
        // document.getElementById("z").innerHTML = stopId; //預判
        ...
        stopId=requestAnimationFrame(animate);	//為了cancel //只會執行一次
    } //animate
